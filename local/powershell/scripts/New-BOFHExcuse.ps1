...
<#
.SYNOPSIS
    Create an BOFH excuse on the fly
.DESCRIPTION
    Create an excuse like a bastard operator from hell.
.LINK
    https://pages.cs.wisc.edu/~ballard/bofh
.EXAMPLE
	C:\PS>.\bofh-Generator.ps1
	
    This command will net you the best excuse for the situation
.NOTES
 	History:
 		v 1.0 - Initial version
 		v 2.0 - Cached a local list to increase speed and decrease 403s.
#>
...
Write-Output "The cause of the problem is...$($responses[$(Get-Random -Maximum $responses.Count)])"
