    ...
    begin {
        ...
        function Install-UbuntuPackages {
            ...
            if (Test-Path -Path $aptRepositories) {
                ...
                Write-Information "Apt Repos to register $($packages.Length): $packages"

                sudo add-apt-repository --yes @packages
                sudo apt-get update
            }
            ...
            if (Test-Path -Path $ubuntuInstalls) {
                ...
                Write-Information "Apt Packages to install $($packages.Length): $packages"
